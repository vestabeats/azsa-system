...
const UserAvatar: React.FC = () => {
  ...
  return (
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left '>
          <div>
            ...
            <Menu.Button className='w-10 h-10 2xl:w-12 2xl:h-12 flex items-center justify-center rounded-full bg-green-600'>
            {user?.passportphoto?.length!==0? (
            <img
              className="w-12 h-12 mb-3 rounded-full mt-3 shadow-lg"
      ...
      <ProfileView open={open} setOpen={setOpen} userData={user} />
